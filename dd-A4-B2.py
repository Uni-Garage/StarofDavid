...
class StarOfDavidGUI:
    def __init__(self, root):
        ...
        # Output panel (to display the final result of formed Star of David symbols as letters)
    ...
    def draw_star_of_david_output(self, canvas, x_offset, y_offset, selected_edges):
        ...
        # Draw the upward triangle with selected edges highlighted
        for i in range(3):
        ...
        # Draw the downward triangle with selected edges highlighted
        for i in range(3):
